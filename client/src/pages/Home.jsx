...
import "../index.css"; // for shimmer animation
    ...
    <div className="relative min-h-screen w-full bg-gradient-to-br from-gray-900 via-green-900 to-black text-white overflow-x-hidden overflow-y-auto">
      ...
      <div className="relative z-10 flex flex-col md:flex-row items-center justify-between min-h-screen px-6 md:px-20 py-10 md:py-0 space-y-10 md:space-y-0">
        ...
        >
          ...
          <h1 className="text-4xl md:text-6xl font-extrabold text-white mb-6 leading-tight relative overflow-hidden">
            <span className="relative z-10">
              Manage Your Finances <br /> Smartly with{" "}
          ...
          <p className="text-gray-300 text-lg leading-relaxed mb-8">
            Keep track of every rupee you earn and spend. Analyze your income,
            control your expenses, and plan your financial future — all in one place.
          </p>
          ...
          <motion.button
            ...
            className="px-6 py-3 bg-gradient-to-r from-green-400 to-emerald-500 text-black font-semibold rounded-xl shadow-lg"
          >
            Get Started
          </motion.button>
        </motion.div>
        ...
        <motion.div
          ...
          animate={{ opacity: 1, x: 0 }}
          transition={{ duration: 0.8 }}
          className="relative w-full md:w-[400px] max-w-md bg-white/10 backdrop-blur-md border border-green-400/30 rounded-2xl shadow-2xl p-8"
        >
          <div className="absolute -z-10 w-64 h-64 bg-green-500/20 rounded-full blur-3xl top-1/2 right-1/3"></div>
